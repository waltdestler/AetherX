...
{
    public class InterstAreaTest : Test
    {
        ...
        private InterstAreaTest()
        {
...

            {
                ...
                ground.OnBeginContact += Ground_OnBeginContact;
                ground.OnEndContact += Ground_OnEndContact;
            }
        ...
        private bool Ground_OnBeginContact(Fixture sender, Fixture other, Contact contact)
        {
        ...
        private void Ground_OnEndContact(Fixture sender, Fixture other, Contact contact)
        {
            Fixture fixtureA = contact.FixtureA;
            Fixture fixtureB = contact.FixtureB;
